...
<!-- Lightbox overlay — wired up in default.html JS -->
<div id="imageLightbox">
  <button id="lightboxClose">✕ close</button>
  <img id="lightboxImg" src="" alt="Portfolio image fullscreen">
</div>
...
<section id="portfolio" class="section">
  ...
  <div id="portfolioContent" class="portfolio-content">
    ...
    <div class="load-more-container">
      ...
      <p class="items-count">
        <span id="shownCount">12</span> of <span id="totalCount">47</span> shown
      </p>
    </div>
  </div>
</section>
...
<section id="texts" class="section">
  <h2>Texts &amp; Papers</h2>
  <p class="section-subtitle">
    Theoretical explorations on algorithmic beauty(?) and the art of hacking anything that interests you :3
  </p>
